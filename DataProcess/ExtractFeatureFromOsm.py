...
本次采用的是：2019.06.14 于 https://download.geofabrik.de/  下载中国的osm文件，然后提取出北京范围的osm文件
提取范围为：left="115.000" right="117.500" top="41.2" bottom="39"
"""
import re
import os
import json
...
def Extract_Way(osmpath,savejsonpath):
    ...
    print("文件保存路径为{}".format(jsonfullpath))
osmpath = "H:\GPS_Data\Road_Network\Beijing\\bjosm\Beijing.osm"
savejsonpath = "H:\GPS_Data\Road_Network\Beijing\\bjosm"
...
#Extract_Way("C:\\Users\Administrator\Desktop\map2.osm","C:\\Users\Administrator\Desktop")
#Find_all_way_node("H:\GPS_Data\Road_Network\Beijing\BJ.osm","H:\GPS_Data\Road_Network\Beijing")
#JsontoKml("H:\GPS_Data\Road_Network\Beijing\\bjosm\highway.json",savejsonpath)